...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gbrea.ipc", false, filepath.Join(os.TempDir(), "gbrea.ipc")},
		{"data", "gbrea.ipc", false, "data/gbrea.ipc"},
		{"data", "./gbrea.ipc", false, "./gbrea.ipc"},
		{"data", "/gbrea.ipc", false, "/gbrea.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gbrea.ipc", true, `\\.\pipe\gbrea.ipc`},
		{"data", "gbrea.ipc", true, `\\.\pipe\gbrea.ipc`},
		{"data", `\\.\pipe\gbrea.ipc`, true, `\\.\pipe\gbrea.ipc`},
	}
