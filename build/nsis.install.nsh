Name "gbrea ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/blessingreacoin/go-breadiuma/issues"
!define UPDATEURL "https://github.com/blessingreacoin/go-breadiuma/releases"
!define ABOUTURL "https://github.com/blessingreacoin/go-breadiuma#ethereum-go"
...
# Install gbrea binary
Section "Gbrea" GETH_IDX
  SetOutPath $INSTDIR
  file {{.Gbrea}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\gbrea.exe" "--fast" "--cache=512"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\gbrea.exe" "attach" "" ""
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe" "" "" ""

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "Gbrea incoming peers (TCP:33760)"
  SimpleFC::AdvRemoveRule "Gbrea outgoing peers (TCP:33760)"
  SimpleFC::AdvRemoveRule "Gbrea UDP discovery (UDP:33760)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Gbrea incoming peers (TCP:33760)" ""  6 1 1 2147483647 1 "$INSTDIR\gbrea.exe" "" "" "Ethereum" 33760 "" "" ""
  SimpleFC::AdvAddRule "Gbrea outgoing peers (TCP:33760)" ""  6 2 1 2147483647 1 "$INSTDIR\gbrea.exe" "" "" "Ethereum" "" 33760 "" ""
  SimpleFC::AdvAddRule "Gbrea UDP discovery (UDP:33760)" "" 17 2 1 2147483647 1 "$INSTDIR\gbrea.exe" "" "" "Ethereum" "" 33760 "" ""

  # Set default IPC endpoint (https://github.com/ethereum/EIPs/issues/147)
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "R" "HKLM" "\\.\pipe\gbrea.ipc"
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "A" "HKLM" "\\.\pipe\gbrea.ipc"
